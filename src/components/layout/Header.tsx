...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
      <div className="container mx-auto flex h-20 items-center justify-between" style={{ paddingLeft: "8%", paddingRight: "8%" }}>
      ...
      {mobileOpen && (
        <div className="lg:hidden border-t bg-white">
          <div className="container mx-auto py-4 space-y-3" style={{ paddingLeft: "8%", paddingRight: "8%" }}>
            {NAV_LINKS.map((link) => (
              <Link
                key={link.href}
                href={link.href}
